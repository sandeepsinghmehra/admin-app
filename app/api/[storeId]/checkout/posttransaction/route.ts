...
export async function POST(
    ...
    console.log("post Transaction body: ", body);
    ...
    try {
        ...
        return NextResponse.redirect(`${process.env.NEXT_PUBLIC_CLIENT_HOST_URI}/order?id=${order._id}`, { status: 301 }); // Replace with your actual confirmation page URL
    } catch (error) {
